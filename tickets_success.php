...
if ($ticket['cust_id'] != $_SESSION['cust_id']) {
...
<head>
  <meta charset="utf-8">
  <title>RZA | Ticket Booking Successful</title>
...
<body>
  ...
  <section class="account-section">
    <div class="account-box active" id="login-box">
      ...
      <p>Thank you, <strong><?= htmlspecialchars($ticket['customer_name']) ?></strong>!</p>
      <p>Your ticket booking has been successfully recorded.</p>
      <br>
      ...
      <table class="receipt-table">
          ...
          <tr>
              <th>Adult Tickets</th>
              <td><?= $ticket['adult_ticket'] ?></td>
          </tr>
          <tr>
              <th>Child Tickets</th>
              <td><?= $ticket['child_ticket'] ?></td>
          </tr>
      </table>
      <br>
